        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-2 sm:p-4">
          ...
          >
            ...
            <div className="relative flex-shrink-0">
              ...
              >
                <Heart className={`w-4 h-4 sm:w-5 sm:h-5 transition-colors ${isFavorite ? 'text-red-500 fill-current' : 'text-gray-600'}`} />
              </button>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <div className="text-xl sm:text-2xl font-bold text-white">
                      {item.price} <span className="text-sm sm:text-lg text-gray-200">DKK</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="mb-4 sm:mb-6">
                  ...
                  <div className="flex items-center text-gray-600 mb-2 sm:mb-3">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-base sm:text-lg">{item.restaurant}</span>
                  </div>
                ...
                {/* Description */}
                <div className="mb-4 sm:mb-6">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">Description</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
                  ...
                  {item.ingredients && (
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Ingredients</h3>
                  ...
                  {/* Dietary Information */}
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Dietary Info</h3>
                ...
                {item.nutritionalInfo && (
                  <div className="mb-4 sm:mb-6">
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Nutrition Facts</h3>
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
                      {Object.entries(item.nutritionalInfo).map(([key, value]) => (
                        <div key={key} className="text-center p-2 sm:p-4 bg-gray-50 rounded-lg sm:rounded-xl">
                          <div className="text-xs sm:text-sm text-gray-500 capitalize font-medium">{key}</div>
                          <div className="text-base sm:text-lg font-bold text-gray-900 mt-0.5 sm:mt-1">{value}</div>
                        </div>
                      ))}
                    </div>
                  </div>
                        ...
                        return (
                          ...
                          >
                            <div className="text-xs font-medium">
                              {isMobile ? date.toLocaleDateString('en-US', { weekday: 'narrow' }) 
                            ...
                            {isToday && (
                              <div className="text-[10px] sm:text-xs mt-0.5 sm:mt-1 opacity-75">Today</div>
                            )}
                          </button>
                        );
                      })}
