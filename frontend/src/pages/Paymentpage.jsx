    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50">
        <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md text-center transform animate-pulse">
          ...
          <p className="text-gray-600 mb-8">Your delicious food is being prepared and will arrive soon.</p>
          <button
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Just a few more steps to enjoy your delicious meal</p>
        </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="ml-11">
                      <textarea
                        ...
                        className={`w-full border-2 rounded-xl p-4 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-blue-100 ${
                          formErrors.address ? 'border-red-400' : 'border-gray-200 focus:border-blue-400'
                        }`}
                        rows="4"
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <h2 className="text-xl font-semibold text-gray-800">Delivery Instructions</h2>
                    </div>
                    <div className="ml-11">
                      <textarea
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="ml-11 space-y-4">
                      ...
                      <div className={`border-2 rounded-xl p-4 transition-all duration-200 cursor-pointer ${
                        paymentMethod === 'credit-card' ? 'border-blue-400 bg-blue-50' : 'border-gray-200 hover:border-gray-300'
                        ...
                        <div className="ml-8 space-y-4 p-6 bg-gray-50 rounded-xl border border-gray-200">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full border-2 rounded-lg p-3 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-blue-100 ${
                                formErrors.cardNumber ? 'border-red-400' : 'border-gray-200 focus:border-blue-400'
                              }`}
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={handleCardChange}
                              className={`w-full border-2 rounded-lg p-3 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-blue-100 ${
                                formErrors.cardName ? 'border-red-400' : 'border-gray-200 focus:border-blue-400'
                              }`}
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <input
                                ...
                                onChange={handleCardChange}
                                className={`w-full border-2 rounded-lg p-3 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-blue-100 ${
                                  formErrors.cardExpiry ? 'border-red-400' : 'border-gray-200 focus:border-blue-400'
                                }`}
                                placeholder="MM/YY"
                                maxLength="5"
                              />
                            ...
                            <div>
                              ...
                              <input
                                ...
                                onChange={handleCardChange}
                                className={`w-full border-2 rounded-lg p-3 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-blue-100 ${
                                  formErrors.cardCvv ? 'border-red-400' : 'border-gray-200 focus:border-blue-400'
                                }`}
                                placeholder="123"
                                maxLength="3"
                              />
                              {formErrors.cardCvv && (
                                <p className="text-red-500 text-sm mt-1">{formErrors.cardCvv}</p>
                              )}
                            </div>
                          </div>
                        </div>
                      ...
                      {/* Mobile Pay Option */}
                      <div className={`border-2 rounded-xl p-4 transition-all duration-200 cursor-pointer ${
                        paymentMethod === 'mobile-pay' ? 'border-green-400 bg-green-50' : 'border-gray-200 hover:border-gray-300'
                      ...
                      {/* QR Code Option */}
                      <div className={`border-2 rounded-xl p-4 transition-all duration-200 cursor-pointer ${
                        paymentMethod === 'qr-code' ? 'border-purple-400 bg-purple-50' : 'border-gray-200 hover:border-gray-300'
                        ...
                        <label className="flex items-center space-x-4 cursor-pointer">
                          ...
                          <div className="flex items-center space-x-3">
                            <div className="text-2xl">📱</div>
                            <span className="font-medium text-gray-800">Pay with QR Code</span>
                          </div>
                        </label>
                      </div>
                      ...
                      <div className={`border-2 rounded-xl p-4 transition-all duration-200 cursor-pointer ${
                        paymentMethod === 'cash' ? 'border-orange-400 bg-orange-50' : 'border-gray-200 hover:border-gray-300'
                  ...
                  {cart.map((item) => (
                    <div key={item.id} className="flex justify-between items-center py-3 border-b border-gray-100">
                      ...
                      <div className="text-right">
                        <p className="font-semibold text-gray-800">DKK {(item.price * item.quantity).toFixed(2)}</p>
                      </div>
                    </div>
                  ))}
                </div>
        ...
        {qrCodeShown && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md text-center">
              ...
              <p className="text-gray-600 mb-4">Scan this QR code with your mobile payment app</p>
              <p className="text-lg font-semibold text-gray-800">Amount: DKK {total.toFixed(2)}</p>
